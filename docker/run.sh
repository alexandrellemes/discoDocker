...
sudo docker-compose exec php-apache sh -c "chmod 777 /var/www/html/meusite/proxy -R"
sudo docker-compose exec php-apache sh -c "chmod 777 /var/www/html/meusite/var -R"
sudo docker-compose exec php-apache sh -c "chmod 777 /var/www/html/meusite/vendor -R"

#echo 'PSS - composer'
#sudo docker-compose exec php-apache sh -c "cd /var/www/html/meusite && composer install"
...
#sudo docker-compose exec php-apache tail -f /var/log/apache2/meusite.local-error.log
#sudo docker-compose exec php-apache tail -f /var/log/apache2/meusite.local-access.log
